const Stripe = require("stripe")("sk_test_51Nihe8J9rr50hPJ7217oJJ7UjopaqchXZcGv7VB7H9uoxxyOuwbNrYoZH6a9BG4RU7vA5uq92w0H5aGNnLWHv93R00e0Hc3Cs1");
...
class PaymentController {
    ...
    static async successPayment(req, res, next) {
        try {
            ...
            res.status(200).json({ message: "Payment succeed", transactionId: transaction.id });
        } catch (error) {
            next(error);
        }
    }
